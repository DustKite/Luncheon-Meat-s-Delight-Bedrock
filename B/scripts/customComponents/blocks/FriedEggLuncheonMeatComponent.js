...
export class FriedEggLuncheonMeatComponent {
    constructor() {
    ...
    onPlayerInteract(args) {
        ...
        if (state < 2) {
            ...
            saturation.setCurrentValue(Math.min(saturation.currentValue + 6, saturation.effectiveMax));
    ...
    register(args) {
        args.blockComponentRegistry.registerCustomComponent('luncheonmeatsdelight:fried_egg_luncheon_meat', new FriedEggLuncheonMeatComponent());
    }
}
__decorate([
...
], FriedEggLuncheonMeatComponent.prototype, "register", null);